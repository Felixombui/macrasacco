...
<div id="responsive-menu-list">
        ...
        <table align="right" width="80%" bgcolor="cyan">
            <tr><td width="13%"><a href="newdeposits.php"><img src="images/deposits.png" align="left" height="20" width="20">New Deposit</a></td><td>
        ...
        <table align="right" width="80%" bgcolor="cyan">
            ...
            <table align="right" width="80%" bgcolor="cyan">
            <tr><td><?php echo '<i>'.$depositerror.'</i>' ?></td></tr>
            </table>
            </td>
        </table>
